...
public class EntornosPGit {
    ...
    public static void main(String[] args) {
        ...
        switch (sc.nextInt()) {
            ...
            case 2:
                //HACER CLASE DesdeConsola QUE PERMITA METER NUMS DESDE CONSOLA!!!--------------------
                DesdeConsola cons = new DesdeConsola();
                //y codificar aquí la llamada a método máximo y mínimo, similar al case 1-------------
                cons.maximo();
                cons.minimo();
                break;
            default:
